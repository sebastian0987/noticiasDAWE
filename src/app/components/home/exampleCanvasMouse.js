...
function Cloud(x,y,dx,cloudWidth,cloudLength){
  ...
  this.draw = function(){
    c.save();
    c.beginPath();
    c.arc(mouse.x, mouse.y, 120, 0, Math.PI * 2, false);
    c.clip();
    c.beginPath();
...
function animate(){
  ...
  var ring3 = new Circle(mouse.x,mouse.y, 245,'rgba(10, 23, 66, 0.5)');
  var ring2 = new Circle(mouse.x,mouse.y, 215,'rgba(9, 30, 75, 0.5)');
  var ring1 = new Circle(mouse.x,mouse.y, 175,'rgba(8, 34, 83, 0.5)');
  var earthBorder = new Circle(mouse.x,mouse.y, 135,'rgb(12, 20, 56)');
  var earth = new Circle(mouse.x,mouse.y, earthWidth,'rgb(25, 118, 181)');
  ...
  var semi = new SemiCircle(mouse.x,mouse.y,earthWidth,'rgba(0, 0, 0, 0.4)');
}
